...
class Category(TimeStampedModel):
    ...
    short_name = models.CharField('Nombre corto',max_length=30,unique=True)
...
class Entry(TimeStampedModel):
    ...
    resume = models.CharField('Resumen',max_length=400)
...
class Like(TimeStampedModel):
    ...
    class Meta:
        unique_together = ("user", "entry")  # un usuario solo puede dar like una vez
